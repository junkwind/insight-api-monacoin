...
Networks.mainnet = Networks.add(coininfo.dongri.main.toBitcore());
Networks.testnet = Networks.add(coininfo.dongri.test.toBitcore());
Networks.livenet = Networks.mainnet;
Message.MAGIC_BYTES = new Buffer('Dongri Signed Message:\n');
